<template>
    <div class="row mt-4">
        <div class="col-2">
            <img src="https://gudlogo.com/wp-content/uploads/2019/08/logo-banh-mi-ngot-5.jpg" style="width: 150px; margin-left: 50px" />
        </div>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid fst-italic">
                    ...
                    <form class="d-flex ms-5">
                        <input class="form-control me-2" type="search" placeholder="Tìm kiếm" name="tukhoa" />
                        <button name="search_product" type="submit">
                            Tìm
                        </button>
                    </form>
                    ...
                    <div v-else-if="store.isAuthenticatedCustomer  ">
                        <nav class="navbar navbar-dark ms-2">
